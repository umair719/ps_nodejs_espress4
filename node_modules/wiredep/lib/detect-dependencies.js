...
function findComponentConfigFile(config, component) {
    ...
    ['bower.json', '.bower.json', 'component.json', 'package.json'].forEach(function (configFile) {
...
function dependencyComparator(a, b) {
    ...
    aNeedsB = Object.keys(a.dependencies).some(function (dependency) {
    ...
    bNeedsA = Object.keys(b.dependencies).some(function (dependency) {
...
function prioritizeDependencies(config, fileType) {
    ...
    return $._(mergeSort(dependencies)).map($.propprop('main')).flatten().value().filter(function (main) {
